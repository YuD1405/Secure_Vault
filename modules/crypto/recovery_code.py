...
def encrypt_recovery_code(
    ...
    try:
        ...
        return True, "Encrypted recovery code successfully.", encrypted_recovery_key_b64

    except Exception as e:
        return False, f"Error encrypting recovery code: {e}", ""
...
def encrypt_private_key_by_recovery_code(
    ...
    try:
        ...
        recovery_code_aes_key = derive_aes_key(recovery_code, salt)
